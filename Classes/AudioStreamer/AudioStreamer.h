...
@interface AudioStreamer : NSObject
{
   ...
   // Level metering -- begin --
   UInt32 numberOfChannels;
   // Level metering -- end --
   
   NSString *mediaType;  // Added by Raizlabs.
   BOOL forceStop;      // Added by Raizlabs.
}
...
@property (copy) NSString *mediaType;     // Added by Raizlabs.

- (id)initWithURL:(NSURL *)aURL;
- (id)initWithURL:(NSURL *)aURL andMediaType:(NSString *)aMedaType;   // Added by Raizlabs.
- (void)start;
- (void)stop;
- (void)pause;
- (BOOL)isPlaying;
